    ...
    <>
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <p className="about-text">I built this website myself as a platform to display my expertise in a variety of programming languages, with a particular focus on JavaScript/Node, Python, and Java. My experience extends to front-end technologies like React, Bootstrap, CSS, and HTML, enabling me to create dynamic and responsive web applications.</p>
