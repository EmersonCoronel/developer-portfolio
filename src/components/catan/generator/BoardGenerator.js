...
function incrementCounter(num) {
    ...
    const nextIndexMap = { 2: 10, 13: 20, 24: 30, 33: 40 };
...
function fillResources(board) {
    // Array of tiles to be distributed on the board
    let tiles = ['Wood', 'Wood', 'Wood', 'Wood', 'Brick', 'Brick', 'Brick', 'Wheat', 'Wheat', 'Wheat', 'Wheat', 'Sheep', 'Sheep', 'Sheep', 'Sheep', 'Ore', 'Ore', 'Ore', 'Desert'];
